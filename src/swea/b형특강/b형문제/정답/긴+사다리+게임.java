...
class UserSolution
{
    ...
    public static void add(int mX, int mY) {  // O(Log N)
    ...
    public static void remove(int mX, int mY) {  // O(Log N)
    ...
    public static int numberOfCross(int mID) {  // O(5000)
        int ret = -1;
        Node now = node[mID];
    ...
    public static int participant(int mX, int mY) {  // O(5000)
