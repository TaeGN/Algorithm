...
class Solution_print {
	...
	private static boolean run(BufferedReader br) throws Exception
	{
		...
		for (int q = 0; q < numQuery; ++q)
		{
			...
			case CMD_MAKE_LIST:
				...
				System.out.println("--- makeList start ---\n");
				System.out.println("mName : " + String.valueOf(mName));
				System.out.println("mCopy : " + mLength);
				System.out.println("mListValue : " + mListValue.length);
				usersolution.makeList(mName, mLength, mListValue);
				System.out.println("--- makeList end ---\n");
				break;
			case CMD_COPY_LIST:
				seed = Integer.parseInt((st.nextToken()));
				...
				System.out.println("--- copyList start ---\n");
				System.out.println("mDest : " + String.valueOf(mDest));
				System.out.println("mSrc : " + String.valueOf(mSrc));
				System.out.println("mCopy : " + (mCopy != 0));
				try {
					usersolution.copyList(mDest, mSrc, (mCopy != 0));
				} catch (Exception e) {
					System.out.println(e.getMessage());
				}
				System.out.println("--- copyList end ---\n");
				break;
	...
	public static void main(String[] args) throws Exception
	{
		...
		System.setIn(new java.io.FileInputStream("src/swea/b형특강/b형문제/p3리스트복사/sample_input.txt"));
